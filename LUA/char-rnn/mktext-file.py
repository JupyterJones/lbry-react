...
nn = len(line)
print "Enter a Priming Text."
INPUT = raw_input("Start with: ")
print "Enter a filename the extesion .txt will be added automatically."
print "If the filename already exists it will be appended"
