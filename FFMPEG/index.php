...
<body>
    ...
    <div class="sectT">
        ...
        <ul>
            ...
            &nbsp;&nbsp;|&nbsp;&nbsp;
            <li><a href="images-to-video-subtitles-add-sound-screen-capture.html" target="_blank">images-to-video-add-sound-screen-capture</a></li>&nbsp;&nbsp;|&nbsp;&nbsp;
            <li><a href="single-image-to-video-add-text-credits.html" target="_blank">single-image-to-video-add-text-credits</a></li>&nbsp;&nbsp;|&nbsp;&nbsp;
            ...
            <li><a href="scrolling-text.html" target="_blank">Create a video of scrolling text 0r add text to a
                    video</a></li>
            <li><a href="video-transitions.html" target="_blank">Creating Video Transitions</a></li>
            &nbsp;&nbsp;|&nbsp;&nbsp;
            <li><a href="https://ottverse.com/crossfade-between-videos-ffmpeg-xfade-filter/">
                    https://ottverse.com/crossfade-between-videos-ffmpeg-xfade-filter/</a></li>&nbsp;&nbsp;|&nbsp;&nbsp;
            <li><a href="#java">animating with Javascript</a></li>&nbsp;&nbsp;|&nbsp;&nbsp;
            <br /><br />

            <li><a href="https://www.adweek.com/digital/royalty-free-music/" target="_blank">Sources:
                    royalty-free-music</a></li>
 ...
 ffmpeg -i background.jpg -vf "movie=input.mp4, scale=460:-1 [inner]; \
 [in][inner] overlay=120:10 [out]" -y scaledoutput.mp4
...
no such filter mpdecimate
    ...
    <h3>docker run -v $(pwd):$(pwd) -w $(pwd) jrottenberg/ffmpeg:3.2-scratch -framerate 30 -i %4d.jpg -vf
        "pad=ceil(iw/2)*2:ceil(ih/2)*2" -c:v libx264 -preset ultrafast -qp 0 -r 30 -pix_fmt yuv420p -y longguide.mp4
    </h3>


    docker run -v $(pwd):$(pwd) -w $(pwd) adiii717/ffmpeg:latest -framerate 30 -i %4d.jpg -vf
    "pad=ceil(iw/2)*2:ceil(ih/2)*2" -c:v libx264 -preset ultrafast -qp 0 -r 30 -pix_fmt yuv420p -y adiiiDocker.mp4<br />

    <h3>WORKS </h3><br />
    docker run -v $(pwd):$(pwd) -w $(pwd) adilm7177/ffmpeg ash -c 'ffmpeg -i images/%04d.jpg -vf
    "pad=ceil(iw/2)*2:ceil(ih/2)*2" -c:v libx264 -preset ultrafast -qp 0 -r 30 -pix_fmt yuv420p -y
    adiiiDocker2.mp4'<br /><br />

    https://hub.docker.com/r/mwader/static-ffmpeg/<br />

    ADD to ~/.bashrc:
    alias FFMPEG='docker run -i --rm -u $UID:$GROUPS -v "$PWD:$PWD" -w "$PWD" mwader/static-ffmpeg:5.0.1-3'<br />
    alias FFPROBE='docker run -i --rm -u $UID:$GROUPS -v "$PWD:$PWD" -w "$PWD" --entrypoint=/ffprobe
    mwader/static-ffmpeg:5.0.1-3'<br /><br />



    docker run -v $(pwd):$(pwd) -w $(pwd) adiii717/ffmpeg:latest -i output60.mp4 -vf mpdecimate,setpts=N/FRAME_RATE/TB
    -map:v 0 scene3.mp4

    </p>
    <h3>FFMPEG Docker images</h3><br />
    jrottenberg/ffmpeg 3.2-scratch 581d1ecfe3e4 7 weeks ago 62.8MB<br />
    adiii717/ffmpeg:latest 070558cc1753 2 years ago 128MB<br />
...
<h2>Need a detail explanation for ffmpeg colorchannelmixer</h2>
<pre>
...
<h3>Average bandwidth required by resolution: H.264 vs. H.265 </h3>
<table>
    <caption>Bandwidth vs Resolutions</caption>
    <th>
        <tbody>
            <tr class="row-1">
                <td class="column-1">
                ...
                <td class="column-2">
                    <strong>H.264/AVC</strong><br />
                    <strong>Bandwidth required</strong>
                </td>
                <td class="column-3">
                    <strong>H.265/HEVC</strong><br />
                    <strong>Bandwidth required</strong>
                </td>
            </tr>
            <tr class="row-2">
                <td class="column-1">480p</td>
                <td class="column-2">1.5 Mbps</td>
                <td class="column-3">0.75 Mbps</td>
            </tr>
            <tr class="row-3">
                <td class="column-1">720p</td>
                <td class="column-2">3 Mbps</td>
                <td class="column-3">1.5 Mbps</td>
            </tr>
            <tr class="row-4">
                <td class="column-1">1080p</td>
                <td class="column-2">6 Mbps</td>
                <td class="column-3">3 Mbps</td>
            </tr>
            <tr class="row-5">
                <td class="column-1">4K</td>
                <td class="column-2">32 Mbps</td>
                <td class="column-3">15 Mbps</td>
            </tr>
        </tbody>
    </th>
</table>
<pre>Resolution  H.264/AVC
...
<h2 id="java">animating with Javascript</h2><br />
<a href="http://css3.bradshawenterprises.com/animations/">http://css3.bradshawenterprises.com/animations/</a><br />

<a href="https://trac.ffmpeg.org/wiki/How%20to%20speed%20up%20/%20slow%20down%20a%20video">SlowDown or Speed up Video -
    ffmpeg.org</a><br />

<a href="https://github.com/slowmoVideo/slowmoVideo/">https://github.com/slowmoVideo/slowmoVideo/</a><br />
<a href="https://github.com/dthpham/butterflow">https://github.com/dthpham/butterflow</a><br />https://ffmpeg.org/ffmpeg-filters.html


<a href="randombio-com.html">COPY OF https://www.randombio.com/linuxsetup141.html</a>

<a href="https://www.boxcast.com/blog/hevc-h.265-vs.-h.264-avc-whats-the-difference">boxcast.com/blog/hevc-h.265-vs.-h.264-avc-whats-the-difference</a>